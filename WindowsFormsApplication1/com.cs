 ...
 namespace UI
{
    ...
    {
       public string  ReMsg="";//收到信息
        public delegate void DtReMsg( ref string msg);
        public DtReMsg bGetMsg;
        public bool bReMsg = false;
        public form()
        {
            InitializeComponent();
            InitralConfig();
        ...
        public void AddData(byte[] data)
        {
            ...
            else
            {
                ...
                MessageBox.Show( string.Format("收到消息11：{0}-", sb.ToString().ToUpper()));
        ...
        private void AddContent(string content)
        {
            ...
            if (bGetMsg != null)
                bGetMsg(ref content); 
            bReMsg = true;
          //  MessageBox.Show( string.Format("收到测试信息：{0}-", content));
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if(bReMsg)
            {
                textBox_Receive.Text = ReMsg;
                
            }
            else
                      textBox_Receive.Text = "等待二维码....";
